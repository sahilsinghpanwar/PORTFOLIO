    ...
    <section className="py-32 bg-[#000000] text-white">
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-3xl text-center md:text-left">
          ...
          <p className="mb-6 text-base text-white/50 md:text-lg">
            {description}
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="top-24 flex h-min w-64 shrink-0 items-center gap-4 md:sticky z-10">
                  <div className="flex items-center gap-3 bg-black/40 border border-white/[0.04] p-3 rounded-2xl backdrop-blur-md">
                    <div className={`p-2 rounded-lg transition-colors ${
                      isActive ? "bg-white text-black" : "bg-white/[0.03] text-white/50"
                    }`}>
                ...
                <article
                  className={
                    "flex flex-col rounded-2xl border p-4 transition-all duration-300 w-full " +
                    (isActive
                      ? "border-white/10 bg-white/[0.03] shadow-[0_10px_30px_rgba(255,255,255,0.02)]"
                ...
                >
                  {entry.image && (
                    <img
                      ...
                      className="mb-4 w-full h-72 rounded-lg object-cover brightness-90 hover:brightness-100 transition-all duration-300"
                      loading="lazy"
                    />
                  )}
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <h2
                        className={
                          "text-md font-bold leading-tight tracking-tight md:text-lg transition-colors duration-200 uppercase " +
                      ...
                      <p
                        className={
                          "text-xs leading-relaxed md:text-sm font-light transition-all duration-300 " +
                          (isActive 
                            ? "text-white/50 line-clamp-none" 
                            : "text-white/45 line-clamp-2")
                        }
                      >
                        {entry.description}
                      </p>
                            ...
                            <div className="rounded-lg border border-white/[0.05] bg-white/[0.01] p-4">
                              <ul className="space-y-2">
                                {entry.items.map((item, itemIndex) => (
                                  ...
                                  >
                                    <div className="mt-2 h-1.5 w-1.5 rounded-full bg-white/40 flex-shrink-0" />
                          ...
                          {entry.button && (
                            <div className="flex justify-end">
                              <Button 
                                variant="default" 
                                size="sm"
                                className="group bg-white hover:bg-white/95 text-black font-semibold tracking-wide transition-all duration-200 rounded-xl" 
                                asChild
                              >
