...
export function MagneticText({
  ...
  return (
    ...
    >
      ...
      <span style={style} className={cn("text-5xl font-bold tracking-tighter text-foreground tracking-wide", textClassName)}>
        {text}
      </span>

      <div
        ref={circleRef}
        className={cn("absolute top-0 left-0 pointer-events-none rounded-full bg-foreground overflow-hidden", circleClassName)}
        style={{
          width: isHovered ? circleWidth : 0,
          height: isHovered ? circleHeight : 0,
